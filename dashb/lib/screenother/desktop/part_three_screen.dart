...
class PartThreeScreen extends StatefulWidget {
  const PartThreeScreen({super.key});

  @override
  State<PartThreeScreen> createState() => _PartThreeScreenState();
}

class _PartThreeScreenState extends State<PartThreeScreen> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(
              width: double.infinity,
                child: Text('GENERAL 10:00 TO 7:00 PM'.toUpperCase(), style: TextStyle(height: 1.5,fontSize: 15, fontWeight: FontWeight.normal , color: Colors.white), textAlign: TextAlign.start,)
            ),
            SizedBox(height: 5,),
